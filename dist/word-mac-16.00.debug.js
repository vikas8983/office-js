...
/* Office.js Version: 16.0.10207.10000 */ 
/*
...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.10207.10000";
...
(function (OfficeExtension_1) {
	...
	var HostBridgeSession=(function (_super) {
		...
		HostBridgeSession.init=function (bridge) {
			if (bridge && typeof (bridge)==="object") {
				...
				SessionBase._overrideSession=session;
	...
	OfficeExtension_1.HostBridgeTest=HostBridgeTest;
	var _Internal;
	(function (_Internal) {
	...
	var OperationalApiHelper=(function () {
		...
		OperationalApiHelper.invokeGet=function (obj, select) {
			var queryOption={};
			if (select) {
		...
		OperationalApiHelper.createMethodObjectAndInvokeGet=function (parent, methodName, operationType, args, isCollection, isInvalidAfterRequest, getByIdMethodName, flags, select) {
			var queryOption={};
			if (select) {
				queryOption.Select=select;
			}
