...
(function (OfficeExtension_1) {
	...
	var RichApiMessageUtility=(function () {
		...
		RichApiMessageUtility.buildRequestMessageSafeArray=function (customData, requestFlags, method, path, headers, body) {
			...
			var instanceId='';
			var marketplaceType='';
			return [customData, method, path, headerArray, body, appPermission, requestFlags, solutionId, instanceId, marketplaceType];
		};
	...
	var ObjectPath=(function () {
		...
		Object.defineProperty(ObjectPath.prototype, "isValid", {
			...
			set: function (value) {
				...
				if (!value && this.m_objectPathInfo.ObjectPathType===6 && this.m_savedObjectPathInfo) {
	...
	var Utility=(function (_super) {
		...
		Utility._parseSelectExpand=function (select) {
			...
			function sanitizeForAnyItemsSlash(propertyName) {
				...
				var isItemsSlashOrItemsDot=propertyNameLower.substr(0, itemsSlashLength)==='items/' || propertyNameLower.substr(0, itemsSlashLength)==='items.';
