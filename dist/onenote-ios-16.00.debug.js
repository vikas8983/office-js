...
(function (OneNote) {
	...
	var Section=(function (_super) {
		...
		Object.defineProperty(Section.prototype, "_scalarPropertyNames", {
			get: function () {
				return ["id", "name", "_ReferenceId", "clientUrl", "webUrl", "isEncrypted", "isUnlocked"];
			},
			enumerable: true,
			configurable: true
		});
		...
		Object.defineProperty(Section.prototype, "isUnlocked", {
			get: function () {
				_throwIfNotLoaded("isUnlocked", this._IsU, _typeSection, this._isNull);
				return this._IsU;
			},
			enumerable: true,
			configurable: true
		...
		Section.prototype._handleResult=function (value) {
			...
			if (!_isUndefined(obj["IsUnlocked"])) {
				this._IsU=obj["IsUnlocked"];
			}
			if (!_isUndefined(obj["Name"])) {
				this._N=obj["Name"];
			}
